...
btn_toggle.addEventListener("click", () => {
    ...
    table.setAttribute("style", "left: 85px")
})
...
function edit_user(obj) {
    ...
    userForm,address.value = row[2],innerHTML;
...
var username = userForm.username.value;
    ...
    var address = userForm.address.value;
    user = {
        id: id,
        username: username,
        address: address,
...
function create_user() {
    ...
    cell5.innerHTML = `<span onclick="edit_user(this)"><i class="fas fa-trash"></i><span>`;
...
function read_data() {
    ...
    for (i = 0; i < localStorage.length; i++) {
        ...
        cell2.innerHTML = user_data.address;
        cell3.innerHTML = user_data.password;
    cell4.innerHTML = `<span onclick="edit_user(this)"><i class="fas fa-edit"></i><span>`;
    cell5.inerHTML = `<span onclick="delete_user(this)"><i class="fas fa-trash"></i><span>`;
